...
const Header = ({ siteTitle, homepage, konami }) => {
        ...
        <header>
            <div>
                <h1 style={{ margin: '-0.2rem 0 0' }}>
                    <AniLink fade to="/">
                        <span style={{ display: konami ? 'block' : 'none' }}>Tom Février</span>
                        {
                            <svg style={{ display: konami ? 'none' : 'block' }} className={homepage ? styles.animated : styles.still} width="265" height="47" viewBox="0 0 265 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M7.01672 23.56H1.29672V17.48H22.0567V23.56H16.3367V45H7.01672V23.56Z" stroke="white" strokeWidth="1.5" />
                                <path
                                    ...
                                    strokeWidth="1.5"
                                />
                                <path d="M56.9555 17.48H65.2755L72.1555 30.84L78.8755 17.48H87.1955V45H78.8755V30.32L73.7955 39.92H70.3955L65.2755 30.32V45H56.9555V17.48Z" stroke="white" strokeWidth="1.5" />
                                <path d="M99.8852 17.48H118.845V23.56H108.485V29.12H118.085V34.16H108.485V45H99.8852V17.48Z" stroke="white" strokeWidth="1.5" />
                                <path d="M122.698 17.48H142.018V23.56H132.418V28.56H141.178V33.6H132.418V38.92H142.018V45H122.698V17.48ZM127.498 10.2L139.218 2L143.258 9.16L129.938 14.48L127.498 10.2Z" stroke="white" strokeWidth="1.5" />
                                <path d="M143.967 17.48H153.007L157.247 34.64L161.487 17.48H170.927L162.327 45H152.127L143.967 17.48Z" stroke="white" strokeWidth="1.5" />
                                <path
                                    ...
                                    strokeWidth="1.5"
                                />
                                <path d="M201.291 17.48H210.531V45H201.291V17.48Z" stroke="white" strokeWidth="1.5" />
                                <path d="M215.745 17.48H235.065V23.56H225.465V28.56H234.225V33.6H225.465V38.92H235.065V45H215.745V17.48Z" stroke="white" strokeWidth="1.5" />
                                <path
                ...
                <nav className={showMobileMenu ? styles.active : ''}>
                    <ul className={konami ? styles.konami : ''}>
                        {site.siteMetadata.menuPaths.map(e => (
                            <li key={e.path}>
                                <AniLink paintDrip color="rebeccapurple" to={e.path}>
                                    {e.name}
                                </AniLink>
                            </li>
                        ))}
                ...
                <div className={classnames(styles.burger, showMobileMenu ? styles.close : '')} onClick={toggleMobileMenu} ref={ref}>
